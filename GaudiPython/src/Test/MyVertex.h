...
static const CLID& CLID_GPyTest_MyVertex = 9998;
...
namespace GPyTest
{
  ...
  */
  ...
  public:
    ...
    static const CLID& classID() { return CLID_GPyTest_MyVertex; }
...
typedef KeyedContainer<GPyTest::MyVertex> MyVertexVector;
