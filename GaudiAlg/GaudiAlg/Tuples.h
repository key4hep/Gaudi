...
namespace Tuples
{
   ...
   *  @date 2005-05-01
   */
  template <class OBJECT,class ARGUMENT=double, class RESULT=typename std::result_of<OBJECT(ARGUMENT)>::type>
  ...
  inline _TupAdapter<OBJECT,double> useFun ( OBJECT object )
  { return { object } ; }
