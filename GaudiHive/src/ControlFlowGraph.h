...
namespace concurrency
{
  ...
  namespace recursive_CF
  {
    ...
    public:
      /// Constructor
      DecisionNode( ControlFlowGraph& graph, unsigned int nodeIndex, const std::string& name, bool modeConcurrent,
    ...
    public:
      /// Constructor
      AlgorithmNode( ControlFlowGraph& graph, Algorithm* algoPtr, unsigned int nodeIndex, unsigned int algoIndex,
    ...
    public:
      ...
      /// Add algorithm node
      StatusCode addAlgorithmNode( Algorithm* daughterAlgo, const std::string& parentName, bool inverted,
                                   bool allPass );
