...
namespace concurrency {
  ...
  //---------------------------------------------------------------------------
  bool CFVisitor::visitEnter(DecisionNode& node) const {
  ...
  //---------------------------------------------------------------------------
  bool CFVisitor::visit(DecisionNode& node) const {
  ...
  //---------------------------------------------------------------------------
  bool CFVisitor::visitLeave(DecisionNode& node) const {
  ...
  //---------------------------------------------------------------------------
  bool CFVisitor::visitEnter(AlgorithmNode& node) const {
  ...
  //--------------------------------------------------------------------------
  bool CFVisitor::visit(AlgorithmNode& node) {
