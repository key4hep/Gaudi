#ifndef GAUDIHIVE_HIVEEVENTLOOPMGR_OLD_H
#define GAUDIHIVE_HIVEEVENTLOOPMGR_OLD_H 1
...
class HiveEventLoopMgr_old : public MinimalEventLoopMgr   {
public:
...
public:
  ...
  HiveEventLoopMgr_old(const std::string& nam, ISvcLocator* svcLoc);
  /// Standard Destructor
  virtual ~HiveEventLoopMgr_old();
