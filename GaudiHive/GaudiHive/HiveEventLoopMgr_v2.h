#ifndef GAUDIHIVE_HIVEEVENTLOOPMGR_v2_H
#define GAUDIHIVE_HIVEEVENTLOOPMGR_v2_H 1
...
class HiveEventLoopMgr_v2 : public MinimalEventLoopMgr   {
public:
...
public:
  ...
  HiveEventLoopMgr_v2(const std::string& nam, ISvcLocator* svcLoc);
  /// Standard Destructor
  virtual ~HiveEventLoopMgr_v2();
