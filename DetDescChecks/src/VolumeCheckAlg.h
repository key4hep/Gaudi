...
namespace DetDesc
{
   ...
   *
   *  The algorithm produces 8 2-dimensional plots with
   ...
   *  form example above should have the same "topological" characteristics
   ...
   *  LAssembly ("Logical Assembly") the parameters should be given by algorithm
