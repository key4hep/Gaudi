...
namespace Gaudi::TestSuite::Conditions {
  namespace details {
    /// Example class to implement an actual backend for Gaudi::TestSuite::Conditions::ConditionAccessorHolder
  ...
  /// \endcode
  ///
  /// See Gaudi::TestSuite::Conditions::UserAlg for example.
  ...
  public:
    ...
    /// the whole name (see Gaudi::TestSuite::Conditions::UserAlg)
