...
from Configurables import Gaudi__TestSuite__MultiInput__DumpAddress as DumpAddress
from Configurables import Gaudi__TestSuite__MultiInput__WriteAlg as WriteAlg
