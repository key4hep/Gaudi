...
singleSleepAlg = AsyncSleeperAlg(
    "SingleSleepAlg", SuspensionDuration=100, SuspensionPoints=1
)  # Single suspension -> two timeline events
doubleSleepAlg = AsyncSleeperAlg(
    "DoubleSleepAlg", SuspensionDuration=100, SuspensionPoints=2
)  # Two suspensions -> three timeline events
sleepersSequencer = Sequencer(
    "Sleepers", Sequential=True, Members=[singleSleepAlg, doubleSleepAlg]
