...
namespace Gaudi {
  ...
  typedef ROOT::Math::SMatrix<double, 2, 5> Matrix2x5; ///< Generic 2x5 matrix (double)
  ...
  typedef ROOT::Math::SMatrix<float, 1, 3> Matrix1x3F; ///< Generic 1x3 matrix (float)
  typedef ROOT::Math::SMatrix<float, 1, 5> Matrix1x5F; ///< Generic 1x5 matrix (float)
  typedef ROOT::Math::SMatrix<float, 1, 6> Matrix1x6F; ///< Generic 1x6 matrix (float)
  typedef ROOT::Math::SMatrix<float, 2, 3> Matrix2x3F; ///< Generic 2x3 matrix (float)
  typedef ROOT::Math::SMatrix<float, 2, 5> Matrix2x5F; ///< Generic 2x5 matrix (float)
  ...
  typedef ROOT::Math::SMatrix<float, 3, 5> Matrix3x5F; ///< Generic 3x5 matrix (float)
