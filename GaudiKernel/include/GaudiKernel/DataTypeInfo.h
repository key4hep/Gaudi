...
public:
  ...
  static int copy( void* tar, const void* src, long typ, int numObj ) {
    ...
    case UCHAR:
      ...
      break;
    case USHORT:
      numObj *= sizeof( unsigned short );
      break;
    case UINT:
      numObj *= sizeof( unsigned int );
      break;
    case ULONG:
      numObj *= sizeof( unsigned long );
      break;
    case ULONGLONG:
      numObj *= sizeof( unsigned long long );
      break;
    case CHAR:
      numObj *= sizeof( char );
      break;
