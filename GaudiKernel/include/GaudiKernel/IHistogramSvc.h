...
public:
  ...
  */
  ...
  virtual AIDA::IHistogram1D* book( const std::string& fullPath, const std::string& title,
                                    std::vector<double> edges ) = 0;
  virtual AIDA::IHistogram1D* book( const std::string& dirPath, const std::string& relPath, const std::string& title,
                                    std::vector<double> edges ) = 0;
  virtual AIDA::IHistogram1D* book( const std::string& dirPath, int hID, const std::string& title,
                                    std::vector<double> edges ) = 0;
  virtual AIDA::IHistogram1D* book( DataObject* pParent, const std::string& relPath, const std::string& title,
                                    std::vector<double> edges ) = 0;
  virtual AIDA::IHistogram1D* book( DataObject* pParent, int hID, const std::string& title,
                                    std::vector<double> edges ) = 0;
  ...
  virtual AIDA::IProfile1D* bookProf( const std::string& fullPath, const std::string& title,
                                      std::vector<double> edges ) = 0;
  virtual AIDA::IProfile1D* bookProf( const std::string& dirPath, const std::string& relPath, const std::string& title,
                                      std::vector<double> edges ) = 0;
  virtual AIDA::IProfile1D* bookProf( const std::string& dirPath, int hID, const std::string& title,
                                      std::vector<double> edges ) = 0;
  virtual AIDA::IProfile1D* bookProf( DataObject* pParent, const std::string& relPath, const std::string& title,
                                      std::vector<double> edges ) = 0;
  virtual AIDA::IProfile1D* bookProf( DataObject* pParent, int hID, const std::string& title,
                                      std::vector<double> edges ) = 0;
  ...
  virtual AIDA::IProfile2D* bookProf( DataObject* pParent, const std::string& relPath, const std::string& title,
                                      std::vector<double> edgesX, std::vector<double> edgesY ) = 0;
  virtual AIDA::IProfile2D* bookProf( DataObject* pParent, int hID, const std::string& title,
                                      std::vector<double> edgesX, std::vector<double> edgesY ) = 0;
  ...
  virtual AIDA::IHistogram3D* book( const std::string& fullPath, const std::string& title, std::vector<double> edgesX,
