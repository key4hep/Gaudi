...
public:
  ...
  virtual StatusCode getHist( const std::string& name, TH1*&,
                              size_t index = 0 ) const = 0;
  virtual StatusCode getHist( const std::string& name, TH2*&,
                              size_t index = 0 ) const = 0;
  virtual StatusCode getHist( const std::string& name, TH3*&,
                              size_t index = 0 ) const = 0;

  virtual StatusCode regSharedHist( const std::string& name,
                                    std::unique_ptr<TH1>&,
                                    LockedHandle<TH1>& ) = 0;
  virtual StatusCode regSharedHist( const std::string& name,
                                    std::unique_ptr<TH2>&,
