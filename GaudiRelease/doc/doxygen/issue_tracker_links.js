...
jQuery.fn.linkToSavannah = function () {
  this.contents()
      ...
      .replaceWith(function() {
        return htmlEncode(this.nodeValue).replace(SAVANNAH_ITEM_REGEX,
...
jQuery.fn.linkToJIRA = function () {
  this.contents()
      .filter(isTextNode)
      .replaceWith(function() {
        return htmlEncode(this.nodeValue).replace(JIRA_ITEM_REGEX,
               function(match, p1) {
...
jQuery.fn.linkToGitLabCommit = function () {
  this.contents()
      .filter(isTextNode)
      .replaceWith(function() {
        return htmlEncode(this.nodeValue).replace(GIT_COMMITS_REGEX,
               function(match) {
...
jQuery.fn.linkToGitLabMR = function () {
	  this.contents()
	      .filter(isTextNode)
	      .replaceWith(function() {
	        return htmlEncode(this.nodeValue).replace(MERGE_REQUESTS_REGEX,
	               function(match, p1, p2) {
	                 if (!p1) p1 = "gaudi/Gaudi";
