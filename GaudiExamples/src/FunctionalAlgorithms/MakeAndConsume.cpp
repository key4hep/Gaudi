...
namespace Gaudi::Examples {
  ...
  struct CountingConsumer final : Gaudi::Functional::Consumer<CountingConsumer, void(), BaseClass_t> {
  ...
  struct IntDataProducer final : Gaudi::Functional::Producer<IntDataProducer, int(), BaseClass_t> {
  ...
  struct KeyedDataProducer final : Gaudi::Functional::Producer<KeyedDataProducer, int_container(), BaseClass_t> {

    KeyedDataProducer( const std::string& name, ISvcLocator* svcLoc )
        : Producer( name, svcLoc, KeyValue( "OutputLocation", "/Event/MyKeyed" ) ) {}

    int_container operator()() const {
  ...
  struct IntDataConsumer final : Gaudi::Functional::Consumer<IntDataConsumer, void( const int& ), BaseClass_t> {
  ...
  struct IntToFloatData final : Gaudi::Functional::Transformer<IntToFloatData, float( const int& ), BaseClass_t> {
  ...
  struct IntFloatToFloatData final
    ...
    float operator()( const int& in1, const float& in2 ) const {
  ...
  struct FloatDataConsumer final : Gaudi::Functional::Consumer<FloatDataConsumer, void( const float& ), BaseClass_t> {
  ...
  struct ContextTransformer final
    ...
    int operator()( const EventContext& ctx ) const {
  ...
  struct ContextIntConsumer final
    ...
    void operator()( const EventContext& ctx, const int& i ) const {
  ...
  struct VoidConsumer final : Gaudi::Functional::Consumer<VoidConsumer, void(), BaseClass_t> {

    using Consumer::Consumer;

    void operator()() const { info() << "executing VoidConsumer" << endmsg; }
  };
