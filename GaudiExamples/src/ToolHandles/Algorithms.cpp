...
namespace Gaudi {
  namespace Examples {
    ...
    struct THDataProducer : Gaudi::Functional::Producer<THDataProducer, int(), BaseClass_t> {
    ...
    struct THDataProducer2 : Gaudi::Functional::Producer<THDataProducer2, float(), BaseClass_t> {
    ...
    struct THDataConsumer : Gaudi::Functional::Consumer<THDataConsumer, void( const int& ), BaseClass_t> {
