...
void ApMon::setJobMonitoring(bool jobMonitoring, long interval) {
  char logmsg[100];
  if (jobMonitoring) {
...
void ApMon::setSysMonitoring(bool sysMonitoring, long interval) {
  char logmsg[100];
  if (sysMonitoring) {
...
void ApMon::setGenMonitoring(bool genMonitoring, int nIntervals) {
  char logmsg[100];
