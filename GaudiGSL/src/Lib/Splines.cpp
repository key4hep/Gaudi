...
namespace Genfun {
  namespace GaudiMathImplementation {
    ...
    // ========================================================================
    GSLSpline::GSLSpline( const SplineBase& right ) : AbsFunction(), m_spline( right ) {}
    // ========================================================================

    // ========================================================================
    double GSLSpline::operator()( double x ) const { return m_spline.eval( x ); }
    // ========================================================================
    double GSLSpline::operator()( const Argument& x ) const { return m_spline.eval( x[0] ); }
    // ========================================================================
    ...
    /// constructor from SplineBase
    // ========================================================================
    GSLSplineDeriv::GSLSplineDeriv( const SplineBase& right ) : AbsFunction(), m_spline( right ) {}
    // ========================================================================

    // ========================================================================
    /// copy constructor
    // ========================================================================
    GSLSplineDeriv::GSLSplineDeriv( const GSLSplineDeriv& right ) : AbsFunction(), m_spline( right ) {}
    // ========================================================================

    // ========================================================================
    double GSLSplineDeriv::operator()( double x ) const { return m_spline.deriv( x ); }
    // ========================================================================
    double GSLSplineDeriv::operator()( const Argument& x ) const { return m_spline.deriv( x[0] ); }
    // ========================================================================
    ...
    /// constructor from SplineBase
    // ========================================================================
    GSLSplineDeriv2::GSLSplineDeriv2( const SplineBase& right ) : AbsFunction(), m_spline( right ) {}
    // ========================================================================

    // ========================================================================
    double GSLSplineDeriv2::operator()( double x ) const { return m_spline.deriv2( x ); }
    // ========================================================================
    double GSLSplineDeriv2::operator()( const Argument& x ) const { return m_spline.deriv2( x[0] ); }
    // ========================================================================
    ...
    // ========================================================================
    double GSLSplineInteg::operator()( double x ) const { return m_spline.integ( m_low, x ); }
    // ========================================================================
    double GSLSplineInteg::operator()( const Argument& x ) const { return m_spline.integ( m_low, x[0] ); }
    // ========================================================================
