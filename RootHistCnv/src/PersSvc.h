...
*/
  ...
  private:
    ...
    StringProperty  m_defFileName {this, "OutputFile",  undefFileName,  "default file name"};
    BooleanProperty  m_alphaIds {this, "ForceAlphaIds",  false,  "force alphabetic histograms/ntuple IDs"};
    BooleanProperty  m_outputEnabled {this, "OutputEnabled",  true,  "Flag to enable/disable the output to file."};
