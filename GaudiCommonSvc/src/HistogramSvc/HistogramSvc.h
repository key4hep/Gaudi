...
//------------------------------------------------------------------------------
  ...
  H2D* sliceXY(CSTR /* nameAndTitle */,const H3D& /* h */,int /* low */,int /* high */ ) override NOT_IMPLEMENTED
  H2D* sliceXZ(CSTR /* nameAndTitle */,const H3D& /* h */,int /* low */,int /* high */ ) override NOT_IMPLEMENTED
  H2D* sliceYZ(CSTR /* nameAndTitle */,const H3D& /* h */,int /* low */,int /* high */ ) override NOT_IMPLEMENTED
  ...
  {  return bookProf( name, tit, BINS(x), BINS(y), upper, lower);             }
  P2D* createProfile2D(CSTR name,CSTR title,const Edges& x,const Edges& y,double upper, double lower, CSTR /*opt*/) override
  ...
  //------------------------------------------------------------------------------
  AIDA::ICloud1D* createCloud1D(CSTR, CSTR, int, CSTR)    override NOT_IMPLEMENTED
  AIDA::ICloud1D* createCloud1D(CSTR)                     override NOT_IMPLEMENTED
  AIDA::ICloud1D* createCopy(CSTR, const AIDA::ICloud1D&) override NOT_IMPLEMENTED
  AIDA::ICloud2D* createCloud2D(CSTR, CSTR, int, CSTR)    override NOT_IMPLEMENTED
  AIDA::ICloud2D* createCloud2D(CSTR)                     override NOT_IMPLEMENTED
  AIDA::ICloud2D* createCopy(CSTR, const AIDA::ICloud2D&) override NOT_IMPLEMENTED
  AIDA::ICloud3D* createCloud3D(CSTR, CSTR, int, CSTR)    override NOT_IMPLEMENTED
  AIDA::ICloud3D* createCloud3D(CSTR)                     override NOT_IMPLEMENTED
  AIDA::ICloud3D* createCopy(CSTR, const AIDA::ICloud3D&) override NOT_IMPLEMENTED
