...
AIDA::IHistogram1D* HistogramSvc::book( DataObject* pPar, const string& rel, const string& title, int nx, double lowx,
  ...
  if ( m_defs1D.empty() ) {
    return i_book( pPar, rel, title,
                   Gaudi::createH1D( serviceLocator(), buildHistoPath( pPar ), title, nx, lowx, upx ) );
  }
  ...
  return i_book( pPar, rel, ifound->second.title(),
                 Gaudi::createH1D( serviceLocator(), buildHistoPath( pPar ), ifound->second.title(),
...
AIDA::IProfile1D* HistogramSvc::bookProf( DataObject* pPar, const string& rel, const string& title, int nx, double lowx,
                                          double upx, const string& opt ) {
  return i_book( pPar, rel, title,
                 Gaudi::createProf1D( serviceLocator(), buildHistoPath( pPar ), title, nx, lowx, upx, 0, 0, opt ) );
}
...
AIDA::IProfile1D* HistogramSvc::bookProf( DataObject* pPar, const string& rel, const string& title, int nx, double lowx,
  ...
  return i_book(
      pPar, rel, title,
      Gaudi::createProf1D( serviceLocator(), buildHistoPath( pPar ), title, nx, lowx, upx, upper, lower, opt ) );
}
...
AIDA::IHistogram1D* HistogramSvc::book( DataObject* pPar, const std::string& rel, const std::string& title, Edges e ) {
  return i_book( pPar, rel, title, Gaudi::createH1D( serviceLocator(), buildHistoPath( pPar ), title, e ) );
}
...
AIDA::IProfile1D* HistogramSvc::bookProf( DataObject* pPar, const std::string& rel, const std::string& title,
                                          Edges e ) {
  return i_book( pPar, rel, title, Gaudi::createProf1D( serviceLocator(), buildHistoPath( pPar ), title, e, 0, 0 ) );
}
...
AIDA::IProfile1D* HistogramSvc::bookProf( DataObject* pPar, const std::string& rel, const std::string& title, Edges e,
                                          double upper, double lower ) {
  return i_book( pPar, rel, title,
                 Gaudi::createProf1D( serviceLocator(), buildHistoPath( pPar ), title, e, upper, lower ) );
}
...
AIDA::IHistogram2D* HistogramSvc::book( DataObject* pPar, const std::string& rel, const std::string& title, int nx,
  ...
  return i_book( pPar, rel, title,
                 Gaudi::createH2D( serviceLocator(), buildHistoPath( pPar ), title, nx, lowx, upx, ny, lowy, upy ) );
}
...
AIDA::IProfile2D* HistogramSvc::bookProf( DataObject* pPar, const std::string& rel, const std::string& title, int nx,
                                          ...
                                          double lower ) {
  return i_book( pPar, rel, title,
                 Gaudi::createProf2D( serviceLocator(), buildHistoPath( pPar ), title, nx, lowx, upx, ny, lowy, upy,
                                      upper, lower ) );
}
...
AIDA::IProfile2D* HistogramSvc::bookProf( DataObject* pPar, const std::string& rel, const std::string& title, int nx,
  ...
  return i_book(
      pPar, rel, title,
      Gaudi::createProf2D( serviceLocator(), buildHistoPath( pPar ), title, nx, lowx, upx, ny, lowy, upy, 0, 0 ) );
}
...
AIDA::IHistogram2D* HistogramSvc::book( DataObject* pPar, const std::string& rel, const std::string& title, Edges x,
                                        Edges y ) {
  return i_book( pPar, rel, title, Gaudi::createH2D( serviceLocator(), buildHistoPath( pPar ), title, x, y ) );
}
...
AIDA::IProfile2D* HistogramSvc::bookProf( DataObject* pPar, const std::string& rel, const std::string& title, Edges x,
                                          Edges y ) {
  return i_book( pPar, rel, title, Gaudi::createProf2D( serviceLocator(), buildHistoPath( pPar ), title, x, y, 0, 0 ) );
}
...
AIDA::IProfile2D* HistogramSvc::bookProf( DataObject* pPar, const std::string& rel, const std::string& title, Edges x,
  ...
  return i_book( pPar, rel, title,
                 Gaudi::createProf2D( serviceLocator(), buildHistoPath( pPar ), title, x, y, upper, lower ) );
}
...
AIDA::IHistogram3D* HistogramSvc::book( DataObject* pPar, const std::string& rel, const std::string& title, int nx,
                                        ...
                                        double upz ) {
  return i_book( pPar, rel, title,
                 Gaudi::createH3D( serviceLocator(), buildHistoPath( pPar ), title, nx, lowx, upx, ny, lowy, upy, nz,
                                   lowz, upz ) );
}
...
AIDA::IHistogram3D* HistogramSvc::book( DataObject* pPar, const std::string& rel, const std::string& title, Edges x,
                                        Edges y, Edges z ) {
  return i_book( pPar, rel, title, Gaudi::createH3D( serviceLocator(), buildHistoPath( pPar ), title, x, y, z ) );
}
...
AIDA::IHistogram1D* HistogramSvc::createCopy( DataObject* pPar, const std::string& rel, const AIDA::IHistogram1D& h ) {
  return i_book( pPar, rel, h.title(), Gaudi::createH1D( serviceLocator(), buildHistoPath( pPar ), h ) );
}
...
AIDA::IHistogram2D* HistogramSvc::createCopy( DataObject* pPar, const std::string& rel, const AIDA::IHistogram2D& h ) {
  return i_book( pPar, rel, h.title(), Gaudi::createH2D( serviceLocator(), buildHistoPath( pPar ), h ) );
}
...
AIDA::IHistogram3D* HistogramSvc::createCopy( DataObject* pPar, const std::string& rel, const AIDA::IHistogram3D& h ) {
  return i_book( pPar, rel, h.title(), Gaudi::createH3D( serviceLocator(), buildHistoPath( pPar ), h ) );
}
...
AIDA::IProfile1D* HistogramSvc::createCopy( DataObject* pPar, const std::string& rel, const AIDA::IProfile1D& h ) {
  return i_book( pPar, rel, h.title(), Gaudi::createProf1D( serviceLocator(), buildHistoPath( pPar ), h ) );
}
...
AIDA::IProfile2D* HistogramSvc::createCopy( DataObject* pPar, const std::string& rel, const AIDA::IProfile2D& h ) {
  return i_book( pPar, rel, h.title(), Gaudi::createProf2D( serviceLocator(), buildHistoPath( pPar ), h ) );
}
