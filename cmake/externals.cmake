...
if(NOT GAUDI_USE_SYSTEM_CPP_GSL)
  ...
  find_package(cppgsl)
  set(CPP_GSL_INCLUDE_DIR ${CPPGSL_INCLUDE_DIR})
endif()
if(CPP_GSL_INCLUDE_DIR)
  ...
  set_property(GLOBAL APPEND PROPERTY GAUDI_REQUIRED_PATHS ${CPP_GSL_INCLUDE_DIRS})
else()
...
if(NOT GAUDI_USE_SYSTEM_RANGES_V3)
  ...
  set(RANGES_V3_INCLUDE_DIR ${RANGEV3_INCLUDE_DIR})
endif()
if(RANGES_V3_INCLUDE_DIR)
  ...
  set_property(GLOBAL APPEND PROPERTY GAUDI_REQUIRED_PATHS ${RANGES_V3_INCLUDE_DIRS})
else()
