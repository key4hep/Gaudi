...
function(gaudi_add_module plugin_name)
    ...
    add_custom_command(TARGET ${plugin_name} POST_BUILD
        BYPRODUCTS genConf/${package_name}/${plugin_name}.confdb
                   genConf/${package_name}/${plugin_name}.confdb2_part
                   genConf/${package_name}/${plugin_name}Conf.py # genConf/${package_name}/__init__.py
    ...
    _merge_files(MergeConfDB2 "${CMAKE_BINARY_DIR}/${PROJECT_NAME}.confdb2"  # see private functions at the end
                 ${plugin_name} "${CMAKE_CURRENT_BINARY_DIR}/genConf/${package_name}/${plugin_name}.confdb2_part"
