...
if(NOT GAUDI_INSTALL_PYTHONDIR)
    ...
    if(Python3_Interpreter_FOUND)
        ...
        cmake_path(RELATIVE_PATH Python3_SITELIB BASE_DIRECTORY "${_PYTHON_PREFIX}"
            OUTPUT_VARIABLE _DEFAULT_GAUDI_INSTALL_PYTHONDIR)
    else()
        set(_DEFAULT_GAUDI_INSTALL_PYTHONDIR "python")
    endif()
    set(GAUDI_INSTALL_PYTHONDIR "${_DEFAULT_GAUDI_INSTALL_PYTHONDIR}" CACHE STRING "Install python packages in <prefix>/\${GAUDI_INSTALL_PYTHONDIR}")
endif()
...
# Configure (Ninja-only) job pool for memory-intensive build targets (2 GB per slot)
set(GAUDI_HIGH_MEM_JOB_SLOTS "$ENV{GAUDI_HIGH_MEM_JOB_SLOTS}" CACHE STRING
...
message(DEBUG "Configuring ${GAUDI_HIGH_MEM_JOB_SLOTS} high-memory (2 GB) build slots")
...
$<$<PLATFORM_ID:Darwin>:export DYLD_LIBRARY_PATH=\"$\{LD_LIBRARY_PATH\}\">
