...
if(PKG_CONFIG_FOUND)
  pkg_check_modules(zstd "libzstd" QUIET IMPORTED_TARGET)
  if(TARGET PkgConfig::zstd)
    if(NOT ${CMAKE_FIND_PACKAGE_NAME}_FIND_QUIETLY)
      message(STATUS "  Import target: PkgConfig::libzstd")
    endif()
    return()
  endif()
endif()

# either pkg-config not found or not able to find libzstd
...
if(zstd_FOUND)
  add_library(PkgConfig::zstd IMPORTED INTERFACE)
  target_include_directories(PkgConfig::zstd SYSTEM INTERFACE "${zstd_INCLUDE_DIR}")
  target_link_libraries(PkgConfig::zstd INTERFACE "${zstd_LIBRARY}")
  # Display the imported target for the user to know
  if(NOT ${CMAKE_FIND_PACKAGE_NAME}_FIND_QUIETLY)
    message(STATUS "  Import target: PkgConfig::zstd")
  endif()
endif()
