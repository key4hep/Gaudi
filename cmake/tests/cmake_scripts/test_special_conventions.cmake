...
assert_strequal(CMAKE_PREFIX_PATH "${SPECIALCONVENTIONS_ROOT_DIR};${DEVPROJECT_ROOT_DIR};${NOVERSION_ROOT_DIR};${base_dir}")
assert_strequal(CMAKE_MODULE_PATH "${SPECIALCONVENTIONS_ROOT_DIR};${DEVPROJECT_ROOT_DIR};${NOVERSION_ROOT_DIR};${CMAKE_CURRENT_LIST_DIR};..;.")
