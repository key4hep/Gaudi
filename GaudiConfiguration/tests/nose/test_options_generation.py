from GaudiConfig2.Configurables.TestConf import (
    SimpleOptsAlg, SimpleOptsAlgTool, AlgWithVectors, AlgWithMaps)
...
def test_opt_value():
    assert SimpleOptsAlg(
        'Dummy').__opt_value__() == 'TestConf::SimpleOptsAlg/Dummy'
...
def test_all_options():
    SimpleOptsAlgTool(
        'MyTool', parent=SimpleOptsAlg('Parent', Int=9), Bool=False)
