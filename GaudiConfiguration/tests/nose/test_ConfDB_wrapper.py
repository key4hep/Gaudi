...
def test_entries():
    ...
    assert set(C.__all__) == set(
        ['MyAlgorithm', 'MyOtherAlg', 'Gaudi', 'TestConf'])
    ...
    alt_name = 'TemplatedAlg_int_std__vector_std__string_std__allocator_std__string_s_s_'
