...
namespace DetDesc {
   ...
   */
  GAUDI_API const Gaudi::Transform3D localToGlobalTransformation(const std::vector<double>& translationParams,
   ...
   *
   */
  GAUDI_API void getZYXTransformParameters(const Gaudi::Transform3D& CDM,
                                 ...
                                 double& rotZ           )
  {
    ...
    */
  GAUDI_API ROOT::Math::SMatrix<double,6,6> getTransformJacobian( const Gaudi::Transform3D& transform ) ;
}
