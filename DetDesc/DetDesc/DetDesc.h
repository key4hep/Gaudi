 ...
 *
 * single access point to several useful methods and accessor.
 * The main goal here is to cache references to very useful services
...
namespace DetDesc {
   ...
   */
  GAUDI_API const std::string print (const double value, const char* format = "%9.3g");
   ...
   * @return string representation of the "value"
   */
  GAUDI_API const std::string print (const long value, const char* format = "%d");

  /**
   * Gets an instance of Services
   */
  GAUDI_API Services* services();
