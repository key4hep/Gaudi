...
namespace DetDesc {
   ...
   *
  */
  GAUDI_API const Gaudi::Transform3D localDeltaMatrix(const IDetectorElement* DE,
   ...
   *
  */
  GAUDI_API const Gaudi::Transform3D localDeltaMatrix(const IGeometryInfo* GI,
                                                      const Gaudi::Transform3D& globalDelta);
   ...
   *
   */
  GAUDI_API void localDeltaParameters(const IDetectorElement* DE,
   ...
   *
   */
  GAUDI_API void localDeltaParameters(const IGeometryInfo* GI,
                                      std::vector<double>& trans,
                                      std::vector<double>& rot,
                                      std::vector<double>& pivot);
   ...
   *
  */
  GAUDI_API const Gaudi::Transform3D localDeltaFromGlobalTransform(const IDetectorElement* DE,
   ...
   *
  */
  GAUDI_API const Gaudi::Transform3D localDeltaFromGlobalTransform(const IGeometryInfo* GI,
                                                                   const Gaudi::Transform3D& globalTransform);
   ...
   *
  */
  GAUDI_API const Gaudi::Transform3D localDeltaFromParentTransform(const IDetectorElement* parentDE,
   ...
   *
  */
  GAUDI_API const Gaudi::Transform3D localDeltaFromParentTransform(const IGeometryInfo* parentGI,
   ...
   *
  */
  GAUDI_API const Gaudi::Transform3D localDeltaFromAnyFrame(const Gaudi::Transform3D& frame,
                                                            const IDetectorElement* DE,
  ...
  */
   ...
   *
  */
  GAUDI_API const Gaudi::Transform3D localDeltaFromAnyFrameDelta(const Gaudi::Transform3D& frame,
                                                                 const IDetectorElement* DE,
  ...
  */
  ...
  GAUDI_API const Gaudi::Transform3D globalDeltaFromLocalDeltaPrime(const IDetectorElement*   DE,
  ...
  GAUDI_API const Gaudi::Transform3D globalDeltaFromLocalDeltaPrime(const IGeometryInfo*      GI,
                                                                    const Gaudi::Transform3D& deltaPrime);
  ...
  GAUDI_API const Gaudi::Transform3D globalDelta(const IDetectorElement* DE);
  ...
  GAUDI_API const Gaudi::Transform3D globalDelta(const IGeometryInfo* GI);
  ...
  GAUDI_API const Gaudi::Transform3D relativeTransformation(const IDetectorElement* referenceDE,
                                                            const IDetectorElement* DE);
