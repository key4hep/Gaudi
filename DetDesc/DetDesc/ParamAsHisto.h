...
namespace DetDesc {
  namespace Params {
     ...
     *  @date   2009-12-01
     */
    GAUDI_API const Histo1D *paramAsHisto1D(const Condition *cond, const std::string &name);
     ...
     *  @date   2009-12-01
     */
    GAUDI_API const Histo2D *paramAsHisto2D(const Condition *cond, const std::string &name);
