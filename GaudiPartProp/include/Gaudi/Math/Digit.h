...
namespace Gaudi {
  namespace Math {
    ...
    inline TYPE digits( const TYPE value, const unsigned int N1, const unsigned int N2 ) {
      ...
      if ( N1 >= N2 || N1 > (unsigned int)boost::integer_traits<TYPE>::digits10 ) { return 0; }
      //
